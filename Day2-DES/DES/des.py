...
class des():
    ...
    def run(self, key, text, action=ENCRYPT, padding=False):
        ...
        text_blocks = nsplit(self.text, 8)  # Split the text in blocks of 8 bytes so 64 bits 将文本分割为8个字节(即64位)的块
        result = list()
